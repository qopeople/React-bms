  ...
  const columns = [
    ...
    },
    {
      ...
      },
      {
        ...
        dataIndex: '',
        key: 'x',
        render: (text, record)  => <div><a> <Tag color="cyan">订单详情</Tag></a> <a><Tag color="blue">修改信息</Tag></a></div>,
      },
  ];
class ClientList extends Component{
  ...
  <div>
         <Input.Search size="large" placeholder="关键词搜索" enterButton  style={{ width:300,marginBottom:'20px'}} onChange={ async e => {
            e.persist()
